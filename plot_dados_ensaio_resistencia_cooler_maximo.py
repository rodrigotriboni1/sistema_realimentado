"""
Gera grafico para data/raw/dados_ensaio_resistencia_cooler_maximo.csv.
"""
...
CSV_DEFAULT = Path("data/raw/dados_ensaio_resistencia_cooler_maximo.csv")
...
fig.suptitle("Ensaio: Resistencia 100% -> Cooler 100%", fontsize=13, fontweight="bold")
...
output_path = PLOTS_DIR / "grafico_dados_ensaio_resistencia_cooler_maximo.png"
