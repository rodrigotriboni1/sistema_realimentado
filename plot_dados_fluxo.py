"""
Gera grafico para data/raw/dados_fluxo.csv.
"""
...
CSV_DEFAULT = Path("data/raw/dados_fluxo.csv")
...
fig.suptitle("Ensaio Open-Loop de Fluxo", fontsize=13, fontweight="bold")
...
output_path = PLOTS_DIR / "grafico_dados_fluxo.png"
