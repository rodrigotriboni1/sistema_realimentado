"""
Gera grafico para data/raw/dados_temperatura_ambiente.csv.
"""
...
CSV_DEFAULT = Path("data/raw/dados_temperatura_ambiente.csv")
...
fig.suptitle("Temperatura Ambiente", fontsize=13, fontweight="bold")
...
output_path = PLOTS_DIR / "grafico_dados_temperatura_ambiente.png"
