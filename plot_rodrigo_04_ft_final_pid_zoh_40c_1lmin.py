"""
Gera grafico para data/rodrigo_raw/04_ensaio_ft_final_pid_zoh_40C_1Lmin.csv.
"""
...
CSV_DEFAULT = Path("data/rodrigo_raw/04_ensaio_ft_final_pid_zoh_40C_1Lmin.csv")
...
fig.suptitle("Rodrigo 04: FT Final PID ZOH (40C, 1 L/min)", fontsize=13, fontweight="bold")
...
output_path = PLOTS_DIR / "rodrigo_04_ft_final_pid_zoh_40c_1lmin.png"
